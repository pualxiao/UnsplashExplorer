...
#import "UEAlertController.h"

@implementation UEAlertController
...
+ (instancetype)alertControllerWithTitle:(NSString *)title
    ...
    UEAlertController *alertController = [UEAlertController alertControllerWithTitle:title message:message preferredStyle:UIAlertControllerStyleAlert];
